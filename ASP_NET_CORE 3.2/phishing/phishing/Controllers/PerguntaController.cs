    ...
    public class PerguntaController : Controller
    {
        ...
        public Pergunta GetPerguntaByNumber(int numeroPergunta)
        {
            ...
            perguntas.Add(new Pergunta
            {
                ...
                BotaoRespostas = @"<button class='botao-alternativa' onclick='clicou(""P"")'>PHISHING</button><button class='botao-alternativa' onclick='clicou(""V"")'>VERDADEIRO</button>",
            ...
            perguntas.Add(new Pergunta
            {
                ...
                Num_Pergunta = 3,
                Resposta = "P",
                ConteudoDiv = "<img src = '/static/q3.png'/><p style='display: flex; margin-left: 1rem;'>oi, você se lembra<a href='www.sytez.net' onclick='return false' style='text-decoration: none;'>DESTA FOTO</a>?</p>",
            ...
            perguntas.Add(new Pergunta
            {
                ...
                Num_Pergunta = 7,
                Resposta = "P",
                ConteudoDiv = "<img src = '/static/q7.1.png' /><div style='background-color: #f4f4f4;'><img src = '/static/q7.2.png'/><a href='www.sytez.net' onclick='return false'><img src = '/static/q7.3.png' /></a></div>",
            ...
            perguntas.Add(new Pergunta
            {
                ...
                Num_Pergunta = 8,
                Resposta = "V",
                ConteudoDiv = "<img src = '/static/q8.1.png' /><a href='www.tripit.com' onclick='return false'><img src = '/static/q8.2.png' /></a><img src = '/static/q8.3.png' />",
        ...
        public IActionResult GetNextQuestion(int id)
        {
            ...
            return Json(new { titulo = proxPergunta.Titulo, descricao = proxPergunta.Descricao, numPerguntaAtual = id + 1, proxPergunta.ConteudoDiv });
        }
