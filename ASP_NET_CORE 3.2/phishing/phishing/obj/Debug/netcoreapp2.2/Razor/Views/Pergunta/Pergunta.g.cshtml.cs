#pragma checksum "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "31f43acf7e56221d23c8f6ddfbe6045896dbb301"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"31f43acf7e56221d23c8f6ddfbe6045896dbb301", @"/Views/Pergunta/Pergunta.cshtml")]
    ...
    public class Views_Pergunta_Pergunta : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<phishing.Models.Pergunta>
    {
        ...
        {
#line 2 "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml"
...
#line 6 "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml"
...
#line 10 "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml"
       Write(Model.Titulo);
...
#line 12 "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml"
...
#line hidden
    ...
    <div id=""img-quetoes"" class=""formulario-questoes"">
        <a href=""drive--google.com"" onclick=""return false"">");
            EndContext();
            BeginContext(860, 29, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "31f43acf7e56221d23c8f6ddfbe6045896dbb3015865", async() => {
            }
            );
...
#line 39 "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml"
             Write(Url.Action("SalvaResposta", "Pergunta"));

#line default
#line hidden
                EndContext();
                BeginContext(1419, 402, true);
                WriteLiteral(@"',
...
#line 52 "C:\Users\diogo.xavier\Desktop\Projeto Campanha PHISHING\ASP_NET_CORE 5.0\phishing\phishing\Views\Pergunta\Pergunta.cshtml"
             Write(Url.Action("RespostaPergunta", "Pergunta"));

#line default
#line hidden
                EndContext();
                BeginContext(1864, 1840, true);
                WriteLiteral(@"',
            data: JSON.stringify(resposta),
            dataType: ""json"",
            contentType: ""application/json; charset=utf-8"",
    ...
    function avancaProximaPergunta() {
        ...
        if (parseInt(numPergunta) <= 7) {
            $.get(""/Pergunta/GetNextQuestion/"" + numPergunta, null, function (data) {
                $('#workspace h");
                WriteLiteral(@"1').html(data.titulo);
                $('#workspace p').html(data.descricao);
                $('#respostas').show();
                $('#btnProxPergunta').hide();
                //alterar imagem também
                $('#img-questao').html(data.ConteudoDiv);
                console.log(data.ConteudoDiv)
    ...
    <script runat=”server”>
                private void Page_Load(object sender, System.EventArgs e)
                {
                    ...
                    Response.AddHeader(“Location”, ”/home/autenticacao”);
                }
    </script>
");
                EndContext();
